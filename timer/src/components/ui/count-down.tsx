...
//Function to reset the countdown timer
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center h-screen bg-yellow-400 dark:bg-gray-900">
      {/* Timer box container */}
      <div className="bg-green-300 dark:bg-gray-800 shadow-lg rounded-lg p-8 w-full max-w-md">
        {/* Title of the countdown timer */}
        <h1 className="text-2xl font-bold mb-4 text-gray-800 dark:text-gray-200 text-center">
          Countdown Timer
        </h1>
        {/* Input and set button container */}
        <div className="flex items-center mb-6 bg-teal-300">
          <Input
            type="number"
            id="duration"
          ...
          <Button
            ...
            variant="outline"
            className="text-gray-800 dark:text-gray-200 bg-cyan-600 hover:bg-lime-600"
          >
            Set
          </Button>
        </div>
        ...
        <div className="flex justify-center gap-4">
          <Button
            onClick={handleStart}
            variant="outline"
            className="bg-cyan-600 text-gray-800 hover:bg-lime-600 dark:text-gray-200"
          >
